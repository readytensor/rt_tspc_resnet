# ResNet Time Step Classifier in Torch

ResNet Time Step Classification Model in Torch as per Ready Tensor specifications.
...
- A **ResNet Time Step Classification n** model built using **Torch**
